 ...
 *
 */
public class EEP26ActuatorObstructed extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "ActuatorObstructed";

	// the possible values
	public static final boolean OBSTRUCTED = true;
	public static final boolean FREE = false;

	public EEP26ActuatorObstructed()
	{
		// call the superclass constructor
		super(EEP26ActuatorObstructed.NAME);

		// set the default value
		this.value = EEP26ActuatorObstructed.FREE;
	}

	public EEP26ActuatorObstructed(Boolean value)
	{
		// call the superclass constructor
		super(EEP26ActuatorObstructed.NAME);
