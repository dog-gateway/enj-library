 ...
 *
 */
public class EEP26CoverOpen extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "CoverOpen";

	// the possible values
	public static final boolean OPEN = true;
	public static final boolean CLOSED = false;

	public EEP26CoverOpen()
	{
		// call the superclass constructor
		super(EEP26CoverOpen.NAME);

		// set the default value
		this.value = EEP26CoverOpen.CLOSED;
	}

	public EEP26CoverOpen(Boolean value)
	{
		// call the superclass constructor
		super(EEP26CoverOpen.NAME);
