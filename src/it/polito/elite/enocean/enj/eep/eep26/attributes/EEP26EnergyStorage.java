 ...
 *
 */
public class EEP26EnergyStorage extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "EnergyStorage";

	// the possible values
	public static final boolean CHARGED = true;
	public static final boolean LOW = false;

	public EEP26EnergyStorage()
	{
		// call the superclass constructor
		super(EEP26EnergyStorage.NAME);

		// set the default value
		this.value = EEP26EnergyStorage.LOW;
	}

	public EEP26EnergyStorage(Boolean value)
	{
		// call the superclass constructor
		super(EEP26EnergyStorage.NAME);
