 ...
 *
 */
public class EEP26WindowOpen extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "WindowOpen";

	// the possible values
	public static final boolean OPEN = true;
	public static final boolean CLOSED = false;

	public EEP26WindowOpen()
	{
		// call the superclass constructor
		super(EEP26WindowOpen.NAME);

		// set the default value
		this.value = EEP26WindowOpen.CLOSED;
	}

	public EEP26WindowOpen(Boolean value)
	{
		// call the superclass constructor
		super(EEP26WindowOpen.NAME);
