 ...
 *
 */
public class EEP26EnergyInputEnabled extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "EnergyInputEnabled";

	// the possible values
	public static final boolean ENABLED = true;
	public static final boolean DISABLED = false;

	public EEP26EnergyInputEnabled()
	{
		// call the superclass constructor
		super(EEP26EnergyInputEnabled.NAME);

		// set the default value
		this.value = EEP26EnergyInputEnabled.DISABLED;
	}

	public EEP26EnergyInputEnabled(Boolean value)
	{
		// call the superclass constructor
		super(EEP26EnergyInputEnabled.NAME);
