 ...
 *
 */
public class EEP26BatteryCapacity extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "BatteryCapacity";

	// the possible values
	public static final boolean CHARGED = true;
	public static final boolean NEEEDS_CHANGE = false;

	public EEP26BatteryCapacity()
	{
		// call the superclass constructor
		super(EEP26BatteryCapacity.NAME);

		// set the default value
		this.value = EEP26BatteryCapacity.NEEEDS_CHANGE;
	}

	public EEP26BatteryCapacity(Boolean value)
	{
		// call the superclass constructor
		super(EEP26BatteryCapacity.NAME);
