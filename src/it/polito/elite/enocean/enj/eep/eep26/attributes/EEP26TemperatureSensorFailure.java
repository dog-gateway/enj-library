...
public class EEP26TemperatureSensorFailure extends EEPAttribute<Boolean>
{
	...
	public EEP26TemperatureSensorFailure()
	{
		// call the superclass constructor
		super(EEP26TemperatureSensorFailure.NAME);

		// set the default value
		this.value = EEP26TemperatureSensorFailure.WORKING;
	}

	public EEP26TemperatureSensorFailure(Boolean value)
	{
		// call the superclass constructor
		super(EEP26TemperatureSensorFailure.NAME);
