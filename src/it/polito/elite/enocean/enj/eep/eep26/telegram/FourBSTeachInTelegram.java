...
public class FourBSTeachInTelegram extends FourBSTelegram
{
	...
	// DB0.BIT_2..0 == 000
	public static final byte BIDIRECTIONAL_TEACH_IN_SUCCESSFUL = (byte) 0xf0;
	...
	public FourBSTelegram buildResponse(byte response)
	{
		...
		payloadResp[1] = this.payload[3];
		payloadResp[2] = this.payload[2];
		payloadResp[3] = this.payload[1];
