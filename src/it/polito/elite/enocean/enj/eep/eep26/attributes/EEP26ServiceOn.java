 ...
 *
 */
public class EEP26ServiceOn extends EEPAttribute<Boolean>
{
	// the EEPFunction name
	public static final String NAME = "ServiceOn";

	// the possible values
	public static final boolean ON = true;
	public static final boolean OFF = false;

	public EEP26ServiceOn()
	{
		// call the superclass constructor
		super(EEP26ServiceOn.NAME);

		// set the default value
		this.value = EEP26ServiceOn.OFF;
	}

	public EEP26ServiceOn(Boolean value)
	{
		// call the superclass constructor
		super(EEP26ServiceOn.NAME);
