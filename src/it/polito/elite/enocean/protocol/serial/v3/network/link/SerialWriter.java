...
public class SerialWriter {
	 ...
	 * @param out
	 */
	public SerialWriter(ConcurrentLinkedQueue<Packet> highPriorityTxQueue, ConcurrentLinkedQueue<PacketQueueItem> lowPriorityTxQueue, Semaphore expectedResponse, OutputStream out) {
		super();
